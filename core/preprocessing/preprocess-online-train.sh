...
# extrema check
echo "Extrema check"
python extrema_check.py -v extrema temp extrema
echo -e " -done\n"
# normalization
echo "Normalization"
python normalization.py -v extrema temp temp_nmlzt
echo -e " -done\n"
# window sliding
...
# format
echo "Format"
python format2.py -n ${LEAST_FILE_NUMBER} -v -one ${ONE} temp_wd ${TARGET}
echo -e " -done\n"
rm -rf temp*
